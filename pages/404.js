    ...
    return (
        ...
        <div className="p-52 pt-32 flex justify-center text-center">
            <div className="card bg-white p-10 lg:p-20 rounded-md flex flex-col items-center">
                ...
                <AlertTriangle className="text-red-600 my-10" width={100} height={100} strokeWidth={1} />
                <p className="px-0 xl:px-20 mb-10">
                    ...
                    please contact us <Link href="#"><a className="text-primary">here</a></Link>
                </p>
                <div className="flex flex-col lg:flex-row">
                    <Button outline className="m-2" onClick={router.back}>Back</Button>
                    <Button className="m-2" onClick={()=>router.push("/dashboard")}>Dashboard</Button>
                </div>
            </div>
        </div>
        </>
